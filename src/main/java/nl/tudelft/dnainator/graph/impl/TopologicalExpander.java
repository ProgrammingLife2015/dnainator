 ...
 */
public class TopologicalExpander implements PathExpander<PrimitiveLongSet> {
	...
	@Override
	public Iterable<Relationship> expand(Path path, BranchState<PrimitiveLongSet> state) {
